...
<svg width="64" height="13" viewBox="0 0 64 13" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <circle cx="57.25" cy="6.25" r="6.25" fill="#F3FF90"/>
</svg>
`;

interface ChoicePoint3Props {
  style?: any;
}

export const ChoicePoint3: React.FC<ChoicePoint3Props> = ({ style }) => {
  return (
    <View style={[{ width: 63.5, height: 12.5, justifyContent: 'center', alignItems: 'center' }, style]}>
      <SvgXml xml={choicePoint3Svg} width="100%" height="100%" />
    </View>
  );
};

export default ChoicePoint3; 